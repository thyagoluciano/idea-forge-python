...
from src.models.database_models import Base, PostDB, CommentDB, SaasIdeaDB, ExtractionConfigDB
...
class DatabaseManager:
    ...
    def post_exists(self, post_id, session):
    ...
    def post_already_analyzed(self, post_id, session):
